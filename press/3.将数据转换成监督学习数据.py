...
# load dataset
dataset = read_csv('pollution.csv', header=0, index_col=0)  #选取0行 0列为索引
...
# series_to_supervised() 将数据格式化成监督学习型数据
# - data: 观测序列。格式是一个 list 或 2维 Numpy Array   required
# - n_in: 观测数据input(X)的步长，范围[1, len(data)], 默认为1，即用n_in个数据预测n_out个数据
